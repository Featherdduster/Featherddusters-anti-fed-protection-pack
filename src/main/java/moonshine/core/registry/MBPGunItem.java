...
public class MBPGunItem extends TimelessGunItem {
    ...
    public void addInformation(ItemStack stack, @Nullable World worldIn, List<ITextComponent> tooltip, ITooltipFlag flag) {
        ...
        if(tagCompound != null)
        {
            ...
            tooltip.add((new TranslationTextComponent("info.moonshine.waterlock", new TranslationTextComponent("Rain").mergeStyle(TextFormatting.BOLD)).mergeStyle(TextFormatting.BLUE)));
        }
